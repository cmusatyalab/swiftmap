...
"""
TCP Server for VGGT Mapping System

Receives images from drone clients via TCP connection and manages
keyframe selection for 3D mapping. Compatible with vggt_localization
...
class MappingTCPServer:
    ...
    def __init__(self, host: str = "0.0.0.0", port: int = 43322, 
        ...
        import tempfile
        self.temp_dir = tempfile.mkdtemp(prefix="vggt_mapping_")
    ...
    def initialize(self) -> bool:
        ...
        """
        try:
            print(f"Initializing VGGT Mapping TCP Server on {self.host}:{self.port}")
            
            # Temp directory already created by tempfile.mkdtemp() in constructor
            
            print("VGGT Mapping TCP Server initialized successfully")
            return True
    ...
    def receive_image_from_client(self, client_socket) -> Optional[tuple]:
        ...
        Compatible with vggt_localization test client protocol.
    ...
    def start_server(self):
        ...
        try:
            ...
            print(f"VGGT Mapping TCP Server started on {self.host}:{self.port}")
    ...
    def stop_server(self):
        ...
        print("Stopping VGGT Mapping TCP Server...")
        self.is_running = False
        ...
        print("VGGT Mapping TCP Server stopped")
    ...
    def print_final_stats(self):
        ...
        print("\n" + "="*50)
        print("VGGT MAPPING TCP SERVER STATISTICS")
        print("="*50)
...
if __name__ == "__main__":
    ...
    try:
        if server.initialize():
            print("Test server starting. Use vggt_localization/utils/test_client.py to test.")
            server.start_server()
