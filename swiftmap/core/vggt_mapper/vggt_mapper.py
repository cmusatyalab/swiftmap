...
"""
SwiftMap Mapping Inference Engine
...
class VGGTMapper:
    ...
    def _generate_3d_content(self, predictions: Dict[str, Any], params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Creates directory structure: input_stream_{timestamp}/
    ...
    def _generate_confidence_mapping(self, predictions: Dict[str, Any], 
        ...
        try:
            ...
            # Generate confidence point cloud with consistent parameters
            ...
            scene, stats, ply_path = generate_confidence_point_cloud(
                ...
                colormap="red_to_green",  # red = low quality, green = high quality
