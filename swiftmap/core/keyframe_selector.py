...
class KeyframeSelector:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            print("Starting SwiftMap Mapping Keyframe Selection Engine...")
...
if __name__ == "__main__":
    ...
    print("SwiftMap Mapping Keyframe Selector Test")
    print("Use swiftmap/utils/test_client.py to send test images")
